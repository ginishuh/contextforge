...
function inspectPackage() {
  ...
  const required = [
    ...
    'docs/operations.md',
    'docs/agent-guide.md',
    'docs/guides/bootstrap-and-retrieval.md',
    'docs/guides/candidate-lifecycle.md',
    'docs/guides/closeout-and-corrections.md',
    'docs/guides/distillation-and-jobs.md',
    'docs/guides/embeddings-and-maintenance.md',
    'docs/guides/sessions-and-evidence.md',
    'docs/guides/tool-profiles-and-authority.md',
    'docs/guides/workspaces-and-scope-migration.md',
    ...publishedScripts,
  ];
