const REMOTE_OPERATION_ORDER = Object.freeze([
  ...
  'cancelJob', 'listDueDistillSessions', 'processDueDistills', 'listDueConsolidations', 'processConsolidations',
  'remember', 'promoteMemory', 'promoteMemoryCandidate', 'rejectMemoryCandidate', 'correctMemory',
  'deactivateMemory', 'listMemoryEvents', 'listMemoryCandidates', 'listPreferenceOccurrences',
