const REMOTE_OPERATION_ORDER = Object.freeze([
  ...
  'processDueCandidateAudits', 'listDueConsolidations', 'processConsolidations',
...
const CAPABILITY_GROUPS = Object.freeze({
  ...
  operator: [
    ...
    'processJobs', 'cancelJob', 'processDueDistills', 'processDueCandidateAudits', 'processConsolidations',
    'embeddingInventory',
...
const MCP_MUTATING_METHODS = new Set([
  ...
  'promoteMemory', 'promoteMemoryCandidate', 'rejectMemoryCandidate', 'correctMemory', 'deactivateMemory',
]);
