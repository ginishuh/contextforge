const REMOTE_OPERATION_ORDER = Object.freeze([
  ...
  'listDueCandidateStaleTransitions', 'processDueCandidateStaleTransitions', 'reopenStaleMemoryCandidate',
  ...
  'planMemoryCandidateBacklogAudit', 'routeAuditedMemoryCandidates', 'processApprovedMemoryCandidates',
...
const CAPABILITY_GROUPS = Object.freeze({
  ...
  operator: [
    ...
    'processDueCandidateWakeups', 'processDueCandidateStaleTransitions', 'processApprovedMemoryCandidates', 'processConsolidations',
    'embeddingInventory',
...
const MCP_METHODS = Object.freeze({
  ...
  list_due_candidate_stale_transitions: 'listDueCandidateStaleTransitions',
  process_due_candidate_stale_transitions: 'processDueCandidateStaleTransitions',
  reopen_stale_memory_candidate: 'reopenStaleMemoryCandidate',
...
const MCP_MUTATING_METHODS = new Set([
  ...
  'processDueCandidateAudits', 'processDueCandidateWakeups', 'processDueCandidateStaleTransitions',
