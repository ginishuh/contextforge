...
const REMOTE_METHODS = REMOTE_OPERATION_NAMES;
const UNSCOPED_REMOTE_METHODS = new Set(UNSCOPED_REMOTE_OPERATION_NAMES);
const OPTIONALLY_SCOPED_REMOTE_METHODS = new Set(OPTIONALLY_SCOPED_REMOTE_OPERATION_NAMES);
